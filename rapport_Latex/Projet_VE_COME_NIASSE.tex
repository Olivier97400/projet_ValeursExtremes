...
%A l'aide de la commande fbvevd, ajuster un modèle asymétrique logistique.
%
%D'après le tableau des AIC ci-dessus, le moins mauvais modèle est celui asymétrique logistique. on voit que les estimation des lois marginales ont quasiment les mêmes paramètres que celle obtenue avec la methode univarié donc il n'est pas utilse de faire de transformations.
